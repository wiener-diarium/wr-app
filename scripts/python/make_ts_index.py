...
for x in tqdm(files, total=len(files)):
    ...
    for v in facs:
        ...
        cfts_record["resolver"] = f"https://github.com/wiener-diarium/wr-app/{record['id']}"
...
print(make_index)
print("done with indexing wrd")

make_index = CFTS_COLLECTION.documents.import_(cfts_records, {"action": "upsert"})
print(make_index)
print("done with cfts-index wrd")
